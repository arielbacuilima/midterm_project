...
# vi. The R-squared (R²) is 0.6043, indicating that approximately 60.43% of the variation in 
 # Total Expense is explained by the variation in Beds. This suggests that Beds can reasonably 
 # explain a significant portion of the variability in Total Expense. 

# The p-value for Beds 
 # is < 2.2e-16, indicating a highly significant relationship between Beds and Total Expense. 
 # This suggests that the coefficient for Beds is unlikely to be zero in the population, 
 # further supporting the strong association between these variables.
...
### Profitability Analysis for Option A and Option B:

# Based on the regression analysis
# Considering the expense range of $55–$75 million, the models provide insights into which 
# option might be more profitable:
 # Option A (90–100 beds) might result in lower total expenses compared to Option B (300–400 beds), 
 # primarily due to the smaller size.
 # However, the models indicate that increasing the number of beds has a significant positive 
 ...
 # especially considering the positive correlation between the number of beds and total expenses.
